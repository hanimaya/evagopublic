<?php 
      ...
      $dari_perusahaan   = $_POST['dari_perusahaan'];
      $sampai_perusahaan   = $_POST['sampai_perusahaan'];
 ?>
 <!-- BEGIN CONTENT -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <select name="dari_perusahaan" class="form-control">
                          ...
                          <?php } ?>
                          <?php 
                            $sql_p1  = mysql_query("SELECT nama_emiten FROM tbl_emiten");
                            while($data_p1 = mysql_fetch_assoc($sql_p1)){
                          ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <select name="sampai_perusahaan" class="form-control">
                          ...
                          <?php } ?>
                          <?php 
                            $sql_p2  = mysql_query("SELECT nama_emiten FROM tbl_emiten");
                            while($data_p2 = mysql_fetch_assoc($sql_p2)){
                          ?>
                  ...
                  { 
                      ...
                      data: [
                              <?php
                                ...
                                $sql = mysql_query("SELECT * FROM tbl_emiten,tbl_eva
                          WHERE tbl_eva.kode_emiten=tbl_emiten.kode_emiten
                          AND tbl_emiten.nama_emiten 
                          IN ('$dari_perusahaan','$sampai_perusahaan')
