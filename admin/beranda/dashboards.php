      ...
      chart1 = new Highcharts.Chart({
         ...
         yAxis: {
            ...
            while( $ret = db_fetch_array( $query ) ){
              $merek=$ret['tahun'];                     
                 $sql_jumlah   = "SELECT nilai_eva FROM tbl_eva WHERE tahun='$merek'";        
                 $query_jumlah = db_query(  $sql_jumlah ) or die(mysqli_error($conn));
                 while( $data = db_fetch_array( $query_jumlah ) ){
