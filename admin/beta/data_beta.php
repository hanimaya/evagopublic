            ...
            <div class="grid no-border">
              ...
              <div class="grid-body">
                <table id="dataTables1" class="data-table table table-bordered table-striped" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php 
                        $sql = db_query( "SELECT tbl_emiten.kode_emiten,tbl_ihs.nilai_rm,tbl_ri.bulan,
                      ...
                      <td>
                        <?php
                          ...
                          echo number_format($x2,6,",",".");
                            ...
                            $sql_beta  = db_query( "SELECT * FROM tbl_beta 
                                                      WHERE kode_emiten='$kode_emiten' 
                                                      AND bulan='$bulan'
                                                      AND tahun='$tahun'");
                            $data_beta = db_num_rows($sql_beta);
                            if ($data_beta==0){
                              $sql_beta2 = db_query( "INSERT INTO tbl_beta VALUES (null,'$kode_emiten','$bulan','$tahun','$xy','$x2')");
                            } else if ($data_beta > 0) {
                              $sql_beta2 = db_query( "UPDATE tbl_beta SET xy='$xy',x2='$x2' 
                                                        WHERE kode_emiten='$kode_emiten' 
                                                        AND bulan='$bulan' 
                                                        AND tahun='$tahun'");
                            }
