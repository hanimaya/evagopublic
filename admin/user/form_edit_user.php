        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="grid">
              ...
              <div class="grid-body">
                <form class="form-horizontal" role="form" action="user/edit_user.php" method="post">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Level</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="level" readonly required="" value="<?php echo $data['level']?>">
                    </div>
                  </div>
                  <?php } ?>
                  <!--
