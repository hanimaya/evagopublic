  ...
  ?> 
    ...
    <aside class="right-side">
      ...
      <section class="content-header">
        ...
        <span>Input Data Return Individual</span>
      </section>
      <!-- END CONTENT HEADER -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="grid">
              ...
              <div class="grid-body">
                <form class="form-horizontal" role="form" action="ri/simpan_ri.php" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="number" step="any" class="form-control" name="nilai_pi" value="" />
                    </div>
                  </div>
                  <div class="form-group">
