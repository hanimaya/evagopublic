            ...
            <div class="grid no-border">
              ...
              <div class="grid-body">
                ...
                <table id="dataTables1" class="data-table table table-bordered table-striped" cellspacing="0" width="100%">
                  ...
                  <?php
                    if (empty($dari_tahun)){
                      $sql  = db_query( "SELECT tbl_perusahaan.kode_perusahaan AS kode, 
                  ...
                  ?>
                    <tr>
                      <td>
                        <?php 
                          $sql1  = db_query( "SELECT tahun FROM tbl_rasio_roe WHERE kode_perusahaan='$kode' AND tahun='$tahun'");
                          $data1 = db_fetch_assoc($sql1);
                      ...
                      <td>
                        <?php 
                          $sql2  = db_query( "SELECT hasil_roe FROM tbl_rasio_roe WHERE kode_perusahaan='$kode' AND tahun='$tahun'");
                          $data2 = db_fetch_assoc($sql2);
                        ...
                        <?php 
                          $sql3  = db_query( "SELECT hasil_roi FROM tbl_rasio_roi WHERE kode_perusahaan='$kode' AND tahun='$tahun'");
                          $data3 = db_fetch_assoc($sql3);
                        ...
                        <?php 
                          $sql4  = db_query( "SELECT hasil_cash FROM tbl_rasio_cash WHERE kode_perusahaan='$kode' AND tahun='$tahun'");
                          $data4 = db_fetch_assoc($sql4);
                        ...
                        <?php 
                          $sql5  = db_query( "SELECT hasil_current 
                        ...
                        <br>
                         ...
                         <?php 
                          $sql9  = db_query( "SELECT tbl_perusahaan.*,tbl_rasio_roe.modal,
                      ...
                      <td align="center">
                          ...
                          <?php
                            ...
                            $sql_nilai  = db_query( "SELECT * FROM tbl_nilai WHERE kode_perusahaan='$kode' AND tahun='$data_tahun'");
                            $data_nilai4 = db_num_rows($sql_nilai);
                            echo $data_nilainya = $data_nilai4['id_nilai'];
                            if ($data_nilai4==0){
                              $sql_nilai2 = db_query( "INSERT INTO tbl_nilai VALUES (null,'$kode','$data_tahun','$bobot_seluruh')");
                            } else if ($data_nilai4 > 0) {
                              $sql_nilai2 = db_query( "UPDATE tbl_nilai SET bobot_seluruh='$bobot_seluruh'
