                  ...
                  <tr>
                    ...
                    <td align="right">
                      <?php
                        ...
                        $sql_cost  = db_query( "SELECT * FROM tbl_cost
                                                  WHERE kode_emiten='$kode_emiten_cost' 
                                                  AND tahun='$tahun_cost'
                                                  AND id_user='$id_user'"); 
                            $data_cost = db_num_rows($sql_cost);
                            if ($data_cost==0){
                              $sql_cost2 = db_query( "INSERT INTO tbl_cost 
                                                        VALUES (null,'$kode_emiten_cost','$id_user','$tahun_cost',
                                                        '$cost')");
                            } else if ($data_cost > 0) {
                              $sql_cost2 = db_query( "UPDATE tbl_cost SET nilai_cost='$cost'
                                                        WHERE kode_emiten='$kode_emiten_cost' 
                                                        AND tahun='$tahun_cost'
                                                        AND id_user='$id_user'");
                            }
                  ...
                  <tr>
                    ...
                    <td align="right">
                      <?php 
                        ...
                        $sql_rf  = db_query( "SELECT * FROM tbl_rf 
                                                WHERE tahun='$tahun_sbi'
                                                AND id_user='$id_user'"); 
                            $data_rf = db_num_rows($sql_rf);
                            if ($data_rf==0){
                              $sql_rf2 = db_query( "INSERT INTO tbl_rf 
                                                      VALUES (null,'$id_user','$tahun_sbi','$total_rf')");
                            } else if ($data_rf > 0) {
                              $sql_rf2 = db_query( "UPDATE tbl_rf SET total_rf='$total_rf' 
                                                      WHERE tahun='$tahun_sbi'
                                                      AND id_user='$id_user'");
                            }   
                      ?>
                    ...
                    <td align="right">
                      <?php 
                        ...
                        echo number_format($beta,2,",","."); 
                         $sql_beta  = db_query( "SELECT * FROM tbl_totalbeta 
                                                      WHERE kode_emiten='$kode_emiten_beta' 
                                                      AND tahun='$tahun_ihs'
                                                      AND id_user='$id_user'"); 
                            $data_beta = db_num_rows($sql_beta);
                            if ($data_beta==0){
                              $sql_beta2 = db_query( "INSERT INTO tbl_totalbeta VALUES (null,'$kode_emiten_beta','$id_user','$tahun_ihs','$beta')");
                            } else if ($data_beta > 0) {
                              $sql_beta2 = db_query( "UPDATE tbl_totalbeta SET total_beta='$beta' 
                                                        WHERE kode_emiten='$kode_emiten_beta'
                                                        AND tahun='$tahun_ihs'
                                                        AND id_user='$id_user'");
                            } 
                  ...
                  <tr>
                    ...
                    <td align="right">
                      <?php 
                        ...
                        $sql_rm  = db_query( "SELECT * FROM tbl_rm 
                                                  WHERE tahun='$tahun_ihs'
                                                  AND id_user='$id_user'"); 
                            $data_rm = db_num_rows($sql_rm);
                            if ($data_rm==0){
                              $sql_rm2 = db_query( "INSERT INTO tbl_rm 
                                                      VALUES (null,'$id_user','$tahun_ihs','$total_rm')");
                            } else if ($data_rm > 0) {
                              $sql_rm2 = db_query( "UPDATE tbl_rm SET rata_rm='$total_rm' 
                                                      WHERE tahun='$tahun_ihs'
                                                      AND id_user='$id_user'");
                            }  
                      ?>
                  ...
                  <tr>
                    ...
                    <td align="right">
                      <?php
                        ...
                        $sql_om  = db_query( "SELECT * FROM tbl_om 
                                                WHERE kode_emiten='$kode_emiten_om' 
                                                AND tahun='$tahun_om'
                                                AND id_user='$id_user'"); 
                            $data_om = db_num_rows($sql_om);
                            if ($data_om==0){
                              $sql_om2 = db_query( "INSERT INTO tbl_om 
                                                      VALUES (null,'$kode_emiten_om','$id_user','$tahun_om',
                                                      '$ongkos')");
                            } else if ($data_om > 0) {
                              $sql_om2 = db_query( "UPDATE tbl_om SET nilai_om='$ongkos' 
                                                      WHERE kode_emiten='$kode_emiten_om'
                                                      AND tahun='$tahun_om'
                                                      AND id_user='$id_user'");
                            }  
                  ...
                  <tr>
                    ...
                    <td align="right">
                      <?php
                        ...
                        $sql_ku  = db_query( "SELECT * FROM tbl_ku 
                                                WHERE kode_emiten='$kode_emiten_ku'
                                                AND tahun='$tahun_ku'
                                                AND id_user='$id_user'"); 
                            $data_ku = db_num_rows($sql_ku);
                            if ($data_ku==0){
                              $sql_ku2 = db_query( "INSERT INTO tbl_ku 
                                                      VALUES (null,'$kode_emiten_ku','$id_user','$tahun_ku',
                                                      '$jumlah_ku')");
                            } else if ($data_ku > 0) {
                              $sql_ku2 = db_query( "UPDATE tbl_ku SET nilai_ku='$jumlah_ku' 
                                                      WHERE kode_emiten='$kode_emiten_ku'
                                                      AND tahun='$tahun_ku'
                                                      AND id_user='$id_user'");
                            } 
                    ...
                    <td align="right">
                      <?php
                        ...
                        echo number_format($jumlah_saham,2,",",".")."%";
                         $sql_saham  = db_query( "SELECT * FROM tbl_saham 
                                                    WHERE kode_emiten='$kode_emiten_saham'
                                                    AND tahun='$tahun_saham'
                                                    AND id_user='$id_user'"); 
                            $data_saham = db_num_rows($sql_saham);
                            if ($data_saham==0){
                              $sql_saham2 = db_query( "INSERT INTO tbl_saham 
                                                         VALUES (null,'$kode_emiten_saham','$id_user','$tahun_saham',
                                                         '$jumlah_saham')");
                            } else if ($data_saham > 0) {
                              $sql_saham2 = db_query( "UPDATE tbl_saham SET nilai_saham='$jumlah_saham' 
                                                         WHERE kode_emiten='$kode_emiten_saham'
                                                         AND tahun='$tahun_saham'
                                                         AND id_user='$id_user'");
                            } 
                      ...
                      <?php
                        ...
                        echo number_format($jumlah_wacc,3,",",".");
                         $sql_wacc  = db_query( "SELECT * FROM tbl_wacc 
                                                   ...
                                                   AND id_user='$id_user'"); 
                         $data_wacc = db_num_rows($sql_wacc);
                            if ($data_wacc==0){
                              $sql_wacc2 = db_query( "INSERT INTO tbl_wacc 
                                                         VALUES (null,'$kode_emiten_wacc','$id_user','$tahun_wacc',
                                                         '$jumlah_wacc')");
                            } else if ($data_wacc > 0) {
                              $sql_wacc2 = db_query( "UPDATE tbl_wacc SET nilai_wacc='$jumlah_wacc' 
                                                         WHERE kode_emiten='$kode_emiten_wacc'
                                                         AND tahun='$tahun_wacc'
                                                         AND id_user='$id_user'");
                            } 
                  ...
                  <tr>
                    ...
                    <td align="right">
                      <?php
                        ...
                        $sql_eva  = db_query( "SELECT * FROM tbl_eva 
                                                 WHERE kode_emiten='$kode_emiten_eva'
                                                 AND tahun='$tahun_eva'
                                                 AND id_user='$id_user'"); 
                        $data_eva = db_num_rows($sql_eva);
                            if ($data_eva==0){
                              $sql_eva2 = db_query( "INSERT INTO tbl_eva 
                                                       VALUES (null,'$kode_emiten_eva','$id_user','$tahun_eva',
                                                       '$jumlah_eva')");
                            } else if ($data_eva > 0) {
                              $sql_eva2 = db_query( "UPDATE tbl_eva SET nilai_eva='$jumlah_eva' 
                                                       WHERE kode_emiten='$kode_emiten_eva'
                                                       AND tahun='$tahun_eva'
                                                       AND id_user='$id_user'");
                            }   
